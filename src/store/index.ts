...
//       commit('SET_LANG', {language: payload, force: true})
...
//           browserStorageService.get(STORAGE_KEY)
//             .then(res => {
//               if (typeof res === "string") {
//                 const oldData = JSON.parse(res) || {}
//                 browserStorageService.save(STORAGE_KEY, JSON.stringify({...oldData, ...mutation.payload}))
//               }
//             })
//         }
