module.exports = {
  ...
  data: {
    ...
    settings: {
      ...
      autofill: 'Autofill',
      autofill_desc: 'Fill logins and items across any web automatically. Learn more:',
      what_is_iframe: "What is iframe?",
      show_menu_form: "Show auto-fill menu on form fields",
      menu_off: "Off",
      menu_field_selected: "When field is selected (on focus)",
      menu_icon_selected: "When auto-fill icon is selected",
      enable_autofill: 'Enable Autofill',
      enable_autofill_desc: 'Fill logins and items across the web',
      autofill_on_page_load: "Autofill on page load",
      never_autofill: "Never autofill",
      autofill_page: "Always autofill on a website (Iframes are not included)",
      autofill_page_iframes: "Always autofill on all iframes on a website",
