module.exports = {
  ...
  master_password: {
    ...
    hint_success: 'Vui lòng kiểm tra hộp thư đến của bạn để được hướng dẫn.',
    unlock: 'Mở khóa'
  },
  enum: {
    Login: 'Mật khẩu',
  ...
  data: {
    ...
    settings: {
      ...
      autofill_desc: 'Điền mật khẩu và các mục vào trang web một cách tự động. Tìm hiểu thêm:',
      what_is_iframe: "Iframe là gì?",
      show_menu_form: "Hiển thị menu tự động điền trên các trường biểu mẫu",
      menu_off: "Không hiển thị",
      menu_field_selected: "Khi trường được chọn (tiêu điểm)",
      menu_icon_selected: "Khi chọn biểu tượng tự động điền",
      enable_autofill: 'Bật Tự động điền',
      enable_autofill_desc: 'Điền thông tin đăng nhập và các mục trên web',
      autofill_on_page_load: "Tự động điền khi tải trang",
      never_autofill: "Không tự động điền",
      autofill_page: "Luôn tự động điền trên một trang web (Không bao gồm Iframe)",
      autofill_page_iframes: "Luôn tự động điền vào tất cả iframe trên trang web",
    ...
    login: {
      ...
      unlock: {
        title: "Mở khóa không cần mật khẩu",
        subtitle: "Quản trị viên đã yêu cầu bạn mở khóa kho tiền của mình chỉ bằng phương pháp Không mật khẩu.",
        enter_otp: "Nhập mã OTP bên dưới vào ứng dụng Máy tính để bàn của bạn để tiếp tục Đăng nhập."
      },
      options: {
      ...
      message: {
        ...
        invalid: '{name} là không hợp lệ',
        otp_invalid: 'Đầu vào OTP trên ứng dụng dành cho máy tính để bàn không hợp lệ. Vui lòng thử lại.'
      }
    },
    set_master_pass: {
